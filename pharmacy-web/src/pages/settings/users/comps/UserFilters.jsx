// src/pages/settings/components/UserFilters.jsx
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-9 pr-8 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#000060]/20 focus:border-[#000060] appearance-none cursor-pointer min-w-[180px]"
                >
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-9 pr-8 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#000060]/20 focus:border-[#000060] appearance-none cursor-pointer min-w-[160px]"
              >
