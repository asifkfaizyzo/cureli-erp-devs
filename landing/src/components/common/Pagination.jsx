...
const Pagination = ({ 
  ...
  const btnActive = "bg-[#000060] text-white shadow-md shadow-[#000060]/20 font-semibold scale-105";
  ...
  return (
    <div className="flex w-full items-center justify-between px-4 py-2.5 bg-white select-none">
      <div className="hidden sm:flex items-center gap-3 text-xs font-medium text-gray-500">
        <span>
          Showing <span className="text-[#000060] font-bold">{startItem}-{endItem}</span> of <span className="text-gray-900">{totalItems}</span>
        </span>
        <span className="text-gray-300">|</span>
        <span>
          Page <span className="text-[#000060] font-bold">{currentPage}</span> of <span className="text-gray-900">{totalPages}</span>
        </span>
      </div>
