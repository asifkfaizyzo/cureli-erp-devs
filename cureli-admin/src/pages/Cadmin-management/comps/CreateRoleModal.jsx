// frontend/src/pages/Cadmin-management/comps/CreateRoleModal.jsx
      ...
      >
        ...
        <div className="bg-gradient-to-r from-[#05015A] to-[#0a0280] px-6 py-4 flex-shrink-0">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => !saving && onClose()}
              disabled={saving}
              className="p-2 rounded-lg bg-white/15 text-white hover:bg-white/25 disabled:opacity-50 transition-colors"
            >
              <X size={18} />
            </button>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-gray-50 space-y-5">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
            ...
            {errors.permissions && (
              <p className="text-xs text-red-600 flex items-center gap-1">
                <AlertCircle size={11} /> {errors.permissions}
              </p>
            )}
          ...
          <div className="flex gap-2">
            ...
            >
              {saving ? (
                ...
                <><Save size={15} /> {isEditing ? "Save Changes" : "Create Role"}</>
              )}
            </button>
          </div>
        </div>
