...
//   ChevronDown,
// } from "lucide-react";
// import { TABLE_CONFIG, getRowBgClass, getRoleBadgeStyle } from "../../../config/tableConfig";
// import TableSkeleton from "../../../components/common/TableSkeleton";
// import TableEmptyState from "../../../components/common/TableEmptyState";
// import Pagination from "../../../components/common/Pagination";
// import AdminDetailsModal from "./AdminDetailsModal";
...
//   status: { key: 'status', label: 'Status', width: 100, sortable: false, align: 'center' },
//   lastLogin: { key: 'last_login_at', label: 'Last Login', width: 110, sortable: true, align: 'left' },
//   actions: { key: 'actions', label: 'Actions', width: 90, sortable: false, align: 'center' },
// };
...
//     username: COLUMNS.username.width,
//     contact: COLUMNS.contact.width,
//     role: COLUMNS.role.width,
//     status: COLUMNS.status.width,
//     lastLogin: COLUMNS.lastLogin.width,
...
//   // ✅ Role badge using design system helper
//   const getRoleBadge = (role) => {
//     return <span className={getRoleBadgeStyle(role)}>{role}</span>;
//   };
...
//                     key={admin.id}
//                     style={{ height: `${heights.bodyRow}px` }}
//                     className={getRowBgClass(index, admin.status !== "Active")}
//                   >
//                     {/* Serial Number */}
//                     <td className={`${styles.cell.base} ${styles.cell.muted} font-medium`}>
//                       {startIndex + index + 1}
