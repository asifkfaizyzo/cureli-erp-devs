// frontend/src/pages/Cadmin-management/comps/SelectedPermissionsSummary.jsx
...
const SelectedPermissionsSummary = ({
  ...
  return (
    <div className={`bg-white rounded-xl border p-5 space-y-4 transition-colors
      ...
      {!hasAny && (
        <div className="flex flex-col items-center justify-center py-6 text-center">
          ...
          <p className="text-sm text-gray-500 font-medium">No permissions selected</p>
