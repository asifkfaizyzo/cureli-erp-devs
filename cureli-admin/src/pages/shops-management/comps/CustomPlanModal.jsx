...
const CustomPlanModal = ({
  ...
  const getAutoDescription = () => {
    return shopName
      ? `Custom plan for ${shopName} with ${maxUsers} users and ${maxBranches} branches`
      : `Custom plan with ${maxUsers} users and ${maxBranches} branches`;
  };
  ...
  const handleCreate = async () => {
    ...
    if (!shopId) {
      setError("Shop ID is required for custom plans");
      return;
    }
          ...
          <>
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
              <button
                onClick={() => onClose()}
                disabled={loading}
                className="px-6 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50"
              >
                Cancel
              </button>
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 bg-[#05015A] text-white rounded-lg hover:bg-[#0a0280] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <>
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium truncate">{createdPlan.name}</p>
                    </div>
                    <div>
