...
export default function CreatePlanModal({ 
  ...
  return (
    ...
    >
      <div 
        className="
          bg-white w-full max-w-md mx-4 rounded-2xl shadow-2xl 
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-1">
              New plans are created as <span className="font-medium text-amber-600">DRAFT</span>
            </p>
          </div>

          {/* Info Banner */}
          <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-lg mb-5 text-xs">
            <Info size={16} className="text-blue-600 mt-0.5 flex-shrink-0" />
            <p className="text-blue-700">
              Draft plans can be edited freely. Once activated, plans become immutable 
