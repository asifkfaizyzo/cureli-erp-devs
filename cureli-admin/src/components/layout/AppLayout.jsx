...
//   return (
//     <div className="h-screen w-full flex bg-gray-50 overflow-auto">
...
const AppLayout = () => {
  ...
  return (
    <div className="w-full min-h-screen flex bg-gray-50 overflow-auto">
      ...
      <div className="flex-1 flex flex-col w-full">
        ...
        {/* Page Content - FULLY SCROLLABLE */}
        <main className="w-full px-3 sm:px-4 md:px-6 lg:px-8 pt-20 pb-10 overflow-auto">
