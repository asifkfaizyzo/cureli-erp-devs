...
const Pagination = ({
  ...
  // Don't render if no items at all (optional, remove if you want to show empty state pagination)
  ...
  // --- STYLING CLASSES (Matched InvoicePagination) ---
  ...
  return (
    <div className={`flex w-full items-center justify-between px-4 py-3 select-none ${pagination.wrapper}`}>
      ...
      <div className="flex items-center gap-2 mx-auto sm:mx-0">
        ...
        {/* < PREVIOUS */}
        <button onClick={goPrev} disabled={currentPage === 1} className={btnNav} title="Previous Page">
          <ChevronLeft size={16} />
        </button>
        ...
        {/* > NEXT */}
        <button onClick={goNext} disabled={currentPage === totalPages} className={btnNav} title="Next Page">
