...
export function AuthProvider({ children }) {
  ...
  const fetchProfile = useCallback(async () => {
    ...
    try {
      ...
      setAdmin({
        ...profile,
        // role should already be raw from backend (SUPER_ADMIN, ANALYST, ACCOUNTING)
        // but we'll ensure it's uppercase just in case
        role: profile.role?.toUpperCase() || 'SUPER_ADMIN',
      });
