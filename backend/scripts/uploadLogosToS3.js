...
async function main() {
  ...
  if (!process.env.AWS_ACCESS_KEY_ID || !process.env.AWS_SECRET_ACCESS_KEY) {
    ...
    console.log('   Please add AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY to your .env');
    process.exit(1);
  }
  ...
  if (whiteUrl || darkUrl) {
    ...
    console.log('\n' + '─'.repeat(60));
    console.log('⚠️  IMPORTANT: Make sure your S3 bucket allows public read access!');
    console.log('─'.repeat(60));
