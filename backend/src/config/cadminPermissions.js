...
export const CADMIN_PERMISSION_GROUPS = [
  {
    ...
    permissions: [
      ...
      { key: CADMIN_PERMISSIONS.ADMINS_EDIT,          label: "Edit Admin",             description: "Update admin profile and role assignments" },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: CADMIN_PERMISSIONS.USERS_RESET_PASSWORD, label: "Reset Password",       description: "Send password reset link to user" },
    ],
  },
  {
    module: "Shop Management",
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: CADMIN_PERMISSIONS.SUBSCRIPTIONS_SEND_REMINDER, label: "Send Payment Reminder",      description: "Trigger reminder email/SMS to shop" },
