...
export function enquiryReceivedTemplate(context) {
  ...
  const subject = `[${enquiry_number}] We've received your enquiry - Cureli Health `;
  ...
  <div style="max-width:560px;margin:0 auto;padding:20px;">
    ...
    <div style="background:white;padding:32px;border:1px solid #e5e7eb;border-top:none;">
      ...
      <p style="font-size:14px;color:#555;line-height:1.6;margin:0 0 20px;">
        Thank you for reaching out to <strong>Cureli Health</strong>! We've received your enquiry and our team will review it shortly.
      </p>
