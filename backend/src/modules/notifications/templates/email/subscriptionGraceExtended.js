...
<head>
  ...
  <title>Grace Period Extended - Cureli</title>
</head>
  ...
  <div style="max-width:560px;margin:0 auto;padding:20px;">
    ...
    <div style="background:white;padding:32px;border:1px solid #e5e7eb;border-top:none;">
      ...
      <p style="font-size:14px;color:#555;line-height:1.6;margin:0 0 20px;">
        Great news! Your grace period for <strong style="color:#05015A;">${shop_name || 'your shop'}</strong> has been extended by the <strong>Cureli</strong> support team.
      </p>
      ...
      <div style="background:#f0f9ff;border-left:4px solid #05015A;padding:14px 18px;margin:24px 0;border-radius:0 10px 10px 0;">
        <p style="margin:0 0 6px;color:#05015A;font-size:13px;font-weight:600;">📝 Note from Cureli Support:</p>
      ...
      <p style="font-size:14px;color:#555;line-height:1.6;margin:20px 0;">
        Please use this additional time to complete your payment and maintain uninterrupted access to <strong>Cureli</strong>.
      </p>
      ...
      <div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:14px 18px;margin:24px 0;border-radius:0 10px 10px 0;">
        <p style="margin:0;color:#92400e;font-size:13px;line-height:1.6;">
          ⏰ <strong>Important Reminder:</strong> This extension is a one-time courtesy. Please ensure payment is completed before the new deadline to maintain your Cureli subscription.
        </p>
      </div>
