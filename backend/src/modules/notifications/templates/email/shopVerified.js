...
// ============================================
// SHOP VERIFIED EMAIL TEMPLATE - DARK MODE FIXED
// ============================================
  ...
  <div class="container" style="max-width:560px;margin:0 auto;padding:20px;">
    ...
    <div class="content-bg content" style="background-color:#ffffff;padding:32px;border:1px solid #e5e7eb;border-top:none;">
      ...
      <p class="text-secondary" style="font-size:14px;color:#555555;line-height:1.6;margin:0 0 20px;background-color:#ffffff;">
        Great news! Your shop <strong class="brand-text" style="color:${EMAIL_CONFIG.COLORS.PRIMARY};">${shopName}</strong> has been successfully verified by our team. All your documents have been approved! 🎊
      </p>
      ...
      <!-- CTA Button -->
      ${renderButton({ href: `${EMAIL_CONFIG.FRONTEND_URL}/dashboard`, text: 'Go to Dashboard', emoji: '🏠' })}
