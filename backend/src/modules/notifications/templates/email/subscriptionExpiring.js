...
<head>
  ...
  <title>Subscription Expiring - Cureli Health</title>
</head>
<body style="margin:0;padding:0;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;background:#f4f6fb;">
  <div style="max-width:560px;margin:0 auto;padding:20px;">
    
    <!-- Header -->
    <div style="background:linear-gradient(135deg,${urgencyColor} 0%,${urgencyColor}dd 100%);color:black;padding:32px;text-align:center;border-radius:12px 12px 0 0;">
    ...
    <div style="background:white;padding:32px;border:1px solid #e5e7eb;border-top:none;">
      ...
      <p style="font-size:14px;color:#555;line-height:1.6;margin:0 0 20px;">
        Your <strong>Cureli Health</strong> subscription for <strong style="color:#05015A;">${shop_name || 'your shop'}</strong> is expiring soon. Please renew to continue enjoying uninterrupted service.
      </p>
      ...
      <p style="font-size:13px;color:#888;text-align:center;margin:20px 0 0;line-height:1.5;">
        Questions about renewal? Contact us at <a href="mailto:support@curelihealth.com" style="color:#05015A;text-decoration:none;font-weight:500;">support@curelihealth.com</a>
      </p>
