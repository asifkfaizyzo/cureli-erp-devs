...
// ============================================
// ENQUIRY REPLIED EMAIL TEMPLATE - DARK MODE FIXED
// ============================================
    ...
    <div class="content-bg content" style="background-color:#ffffff;padding:32px;border:1px solid #e5e7eb;border-top:none;">
      ...
      <div class="card-bg" style="background-color:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;margin:24px 0;">
        <table style="width:100%;border-collapse:collapse;">
          <tr>
            <td class="table-label" style="padding:12px 16px;color:#6b7280;font-size:13px;border-bottom:1px solid #e5e7eb;width:100px;background-color:#f9fafb;">Reference</td>
            <td class="table-value" style="padding:12px 16px;color:#05015A;font-weight:700;font-size:14px;border-bottom:1px solid #e5e7eb;background-color:#f9fafb;">${enquiry_number}</td>
          </tr>
          <tr>
            <td class="table-label" style="padding:12px 16px;color:#6b7280;font-size:13px;background-color:#f9fafb;">Subject</td>
            <td class="table-value" style="padding:12px 16px;color:#1f2937;font-weight:500;font-size:14px;background-color:#f9fafb;">${reply_subject}</td>
          </tr>
        </table>
      </div>
      ...
      <p class="text-muted" style="font-size:13px;color:#888888;text-align:center;margin:20px 0 0;line-height:1.5;background-color:#ffffff;">
        Thank you for choosing <strong class="brand-text" style="color:#05015A;">${EMAIL_CONFIG.COMPANY.NAME}</strong>!
      </p>
