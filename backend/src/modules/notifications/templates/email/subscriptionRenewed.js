...
// ============================================
// SUBSCRIPTION RENEWED EMAIL TEMPLATE - DARK MODE FIXED
// ============================================
      ...
      <div class="card-bg" style="background-color:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;margin:24px 0;">
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr>
            ...
            <td class="amount-text" style="padding:12px 16px;color:${EMAIL_CONFIG.COLORS.SUCCESS};font-weight:700;font-size:15px;border-bottom:1px solid #e5e7eb;background-color:#f9fafb;">₹${Number(amount_paid).toLocaleString('en-IN')}</td>
          </tr>
          ` : ''}
          <tr>
            <td class="table-label" style="padding:12px 16px;color:#6b7280;font-size:13px;background-color:#f9fafb;">Valid Until</td>
            <td class="valid-date" style="padding:12px 16px;color:${EMAIL_CONFIG.COLORS.SUCCESS_LIGHT};font-weight:700;font-size:14px;background-color:#f9fafb;-webkit-text-fill-color:${EMAIL_CONFIG.COLORS.SUCCESS_LIGHT};">${endDateFormatted}</td>
          </tr>
        </table>
      </div>
