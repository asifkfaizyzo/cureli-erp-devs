...
<head>
  ...
  <title>Renewal Successful - Cureli</title>
</head>
  ...
  <div style="max-width:560px;margin:0 auto;padding:20px;">
    ...
    <div style="background:white;padding:32px;border:1px solid #e5e7eb;border-top:none;">
      ...
      <p style="font-size:14px;color:#555;line-height:1.6;margin:20px 0;">
        Great news! Your <strong>Cureli</strong> subscription for <strong style="color:#05015A;">${shopName}</strong> has been renewed successfully. You'll continue to have uninterrupted access to all features. 🎉
      </p>
      ...
      <div style="background:#fef9e7;border-left:4px solid #f59e0b;padding:12px 16px;margin:24px 0;border-radius:0 8px 8px 0;">
        <p style="margin:0;color:#92400e;font-size:13px;text-align:center;">
          💚 <strong>Thank you for your continued trust in Cureli!</strong>
        </p>
      </div>
