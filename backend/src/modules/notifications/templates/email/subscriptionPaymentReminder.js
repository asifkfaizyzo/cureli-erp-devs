...
// ============================================
// SUBSCRIPTION PAYMENT REMINDER EMAIL TEMPLATE - DARK MODE FIXED
  ...
  <div class="container" style="max-width:560px;margin:0 auto;padding:20px;">
    ...
    <div class="content-bg content" style="background-color:#ffffff;padding:32px;border:1px solid #e5e7eb;border-top:none;">
      ...
      <p class="text-secondary" style="font-size:14px;color:#555555;line-height:1.6;margin:0 0 20px;background-color:#ffffff;">
        This is a friendly reminder from the <strong>${EMAIL_CONFIG.COMPANY.NAME}</strong> team about your subscription for <strong class="brand-text" style="color:${EMAIL_CONFIG.COLORS.PRIMARY};">${shop_name || 'your shop'}</strong>.
      </p>
      ...
      <div class="urgency-box" style="background-color:${urgencyBg};border:2px solid ${urgencyColor};border-radius:10px;padding:20px;margin:24px 0;">
        ...
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr>
            ...
            <td class="amount-due" style="padding:8px 0;font-weight:700;font-size:16px;text-align:right;color:${urgencyColor};background-color:${urgencyBg};-webkit-text-fill-color:${urgencyColor};">₹${Number(plan_price).toLocaleString('en-IN')}</td>
          </tr>
          ` : ''}
          <tr>
            <td class="table-label" style="padding:8px 0;color:#6b7280;font-size:13px;background-color:${urgencyBg};">${is_in_grace ? 'Grace Ends' : 'Expires On'}</td>
          ...
          <tr>
            ...
            <td class="days-left" style="padding:8px 0;font-weight:700;font-size:17px;text-align:right;color:${urgencyColor};background-color:${urgencyBg};-webkit-text-fill-color:${urgencyColor};">${days_remaining} days</td>
          </tr>
          ` : ''}
        </table>
      </div>
