...
export const AuditAction = Object.freeze({
  ...
  BRANCHES_DEACTIVATED_DUE_TO_PLAN_DOWNGRADE: 'BRANCHES_DEACTIVATED_DUE_TO_PLAN_DOWNGRADE',
  ...
  SHOP_VERIFICATION_FILE_BATCH_VERIFIED: 'SHOP_VERIFICATION_FILE_BATCH_VERIFIED',

  // metadata: { file_ids: [...], reason, rejected_by_cadmin_id }
  SHOP_VERIFICATION_FILE_BATCH_REJECTED: 'SHOP_VERIFICATION_FILE_BATCH_REJECTED',
