  ...
  return (
    <SafeAreaView style={s.container} edges={['top', 'bottom']}>
      <View style={s.inner}>
        ...
        <View style={s.card}>
          <Text style={s.body}>
            Unfortunately, your application to become a Cureli delivery rider has not been approved at this time.
          </Text>
          <Text style={s.body}>
            Please contact Cureli support for more information.
          </Text>
        </View>
