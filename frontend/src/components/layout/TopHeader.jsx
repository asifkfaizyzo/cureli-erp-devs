...
const AuthenticatedTopHeader = () => {
  ...
  const roleConfig = {
    ...
    branch_admin: { label: 'Branch Admin', color: 'bg-blue-100 text-blue-700',     icon: Building2 },
      ...
      <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-white border-b border-gray-200/80 shadow-sm">
        <div className="h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <>
                          ...
                          >
                            <div className={`w-8 h-8 rounded-md flex items-center justify-center ${
                              ...
                              <Layers size={14} className={isAllBranches ? 'text-[#000060]' : 'text-gray-500'} />
                            </div>
                            ...
                            {isAllBranches && <Check size={14} className="text-[#000060]" />}
                          </button>
            ...
            <RenewalPill />
            {needsRenewal && isSuperAdmin && <div className="w-px h-8 bg-gray-200" />}
                ...
                <div className="absolute right-0 top-full mt-2 w-72 bg-white rounded-xl border border-gray-200 shadow-xl overflow-hidden z-50">
                  ...
                  <div className="py-2">
                    {hasPermission(PERMISSIONS.TICKETS_VIEW) && (
                      <button
                        onClick={() => { navigate('/tickets'); setShowProfileMenu(false); }}
