...
const OnboardingPage = () => {
    ...
    const renderStep = () => {
        switch (progressStep) {
            ...
            case 7: return <UploadRegistration onContinue={handleContinue} />;
            case 8: return <UploadProof onContinue={handleContinue} />;
            case 9: return <UploadEALisence onContinue={handleContinue} />;
            case 10: return <UploadBPan onContinue={handleContinue} />;
            case 11: return <UploadAddressProof onContinue={handleContinue} />;
            case 12: return <VerificationPending onContinue={handleContinue} />;
            case 13: return <OnboardSuccess onStart={handleContinue} />;
            default: return null;
        }
    };
