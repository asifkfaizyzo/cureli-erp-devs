      ...
      {invoice.customer ? (
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#000060]/40">No customer record linked</p>
          </div>
        </div>
      )}
    </div>
...
const ViewRightPanel = ({ invoice, formatCurrency, formatDate, totalQty, itemCount }) => (
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div>
                      <span className="font-medium text-[#000060] text-sm">
                        {item.medicine?.name || item.product_name || "Unknown Product"}
                      </span>
                  ...
                  <td className="px-4 py-3 text-right text-sm text-[#000060]/70">
                    {formatCurrency(item.selling_rate || item.unit_price)}
                  </td>
        ...
        {invoice.lineItems && invoice.lineItems.length > 0 && (
          <tfoot className="sticky bottom-0 border-t-2 border-[#000060]/20 bg-white">
            <tr className="text-sm font-semibold">
              <td colSpan={4} className="px-4 py-4 text-right text-[#000060]/60">
                Grand Totals
              </td>
