// frontend/src/pages/plan-selection/comps/PlanConfirmModal.jsx
        ...
        <div className="p-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              ...
              <div className={`rounded-xl p-4 border-2 ${getCardBg()}`}>
                ...
                <div className="flex items-center flex-wrap gap-2 mb-0.5">
                  ...
                  {introActive && (
                    <span className="px-2 py-0.5 bg-sky-100 text-sky-700
                  ...
                  {plan.is_featured && (
                    <span className="px-2 py-0.5 bg-violet-100 text-violet-700
                                     text-[10px] font-semibold rounded-full
                                     flex items-center gap-1">
                      <Sparkles size={10} />
                      POPULAR
                ...
                <div className="flex flex-col">
                  ...
                  {hasPromoWithPrice && !introActive && (
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      /year after{" "}
                      {formatDate(new Date(plan.promo_free_until))}
                    </p>
                  )}
                </div>
                ...
                {introPhaseDescription && (
                  <div className="mt-3 p-2.5 bg-sky-100 rounded-lg
            ...
            <div className="space-y-3">
              ...
              {/* Free / promo info */}
              {isEffectivelyFree && (
                <div className="bg-emerald-50 rounded-lg p-3 border
                                border-emerald-100">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <Check size={14} />
                    Activate{" "}
                    {hasPromoWithPrice ? "Promo" : "Free"} Plan
                  </>
                ) : introActive ? (
                  <>
                    <Shield size={14} />
