...
export const createTicket = (ticketData) => {
  ...
  if (hasFiles) {
    ...
    if (ticketData.other_category_text) formData.append("other_category_text", ticketData.other_category_text);
    ...
    if (ticketData.contact_number) formData.append("contact_number", ticketData.contact_number);
    if (ticketData.preferred_slot) formData.append("preferred_slot", ticketData.preferred_slot);
